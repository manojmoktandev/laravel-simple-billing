        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <div class="clearfix">
                    ...
                    <div class="text-center">
                        <span>Ktm-447001 (Raj.) Nepal</span><br>
                ...
                <div class="row border">
                    ...
                    <div class="col-sm-6 col-lg-3 mt-1">
                        <ul class="list-unstyled">
                            <li><b>Total :</b> <span class="float-right"><i class="fas fa-dollar-sign"></i> {{ $bill->total_amount }}</span></li>
                            <li><b>CGST :</b><span class="float-right"><i class="fas fa-dollar-sign"></i> {{ $bill->cgst_amount }}</span></li>
                            <li><b>SGST :</b><span class="float-right"><i class="fas fa-dollar-sign"></i> {{ $bill->sgst_amount }}</span></li>
                            <li><b>IGST :</b><span class="float-right"><i class="fas fa-dollar-sign"></i> {{ $bill->igst_amount }}</span></li>
                            <li><b>Total Tax :</b><span class="float-right"><i class="fas fa-dollar-sign"></i> {{ $bill->tax_amount }}</span></li>
                            <li><b>Net Amount :</b><span class="float-right"><i class="fas fa-dollar-sign"></i> {{ $bill->net_amount }}</span></li>
                        </ul>
                ...
                <div class="mt-4 mb-1">
                    <div class="text-right d-print-none">
                        ...
                        <a href="{{ route('manage-gst-bills') }}" class="btn btn-danger waves-effect waves-light">All
                            Bills <i class="fas fa-dollar-sign"></i></a>
                    </div>
                </div>
            </div> <!-- end card-box -->
        </div>
