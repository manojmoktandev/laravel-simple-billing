                                ...
                                <div class="row border">
                                    ...
                                    <div class="col-sm-6 col-lg-3 mt-1">
                                        <ul class="list-unstyled">
                                            <li><b>Total :</b> <span class="float-right"><i class="fas fa-dollar-sign"></i>
                                                    0.00</span></li>
                                            <li><b>TAX :</b><span class="float-right"><i class="fas fa-dollar-sign"></i>
                                                    0.00</span>
                                            </li>
                                            <li><b>Grand Total :</b><span class="float-right"><i class="fas fa-dollar-sign"></i>
                                                    0.00</span>
                                            </li>
                                        </ul>
